 ...
 */
export function fromUuid(uuid: string, options?: {
 ...
 */
export function fromUuidSync(uuid: string, options?: {
    relative?: Document<object, foundry.abstract.types.DocumentConstructionContext> | undefined;
    invalid?: boolean | undefined;
 ...
 */
export function getPlaceableObjectClass(documentName: string): typeof PlaceableObject | undefined;
/**
 ...
 */
export function performIntegerSort(source: object, { target, siblings, sortKey, sortBefore }?: {
 ...
 */
export function getCacheBustURL(src: string): string | boolean;
/**
 ...
 */
export function fetchResource(src: string, { bustCache }?: {
    bustCache?: boolean | undefined;
}): Promise<Blob>;
import type Document from "@common/abstract/document.mjs";
import type PlaceableObject from "@client/canvas/placeables/placeable-object.mjs";
