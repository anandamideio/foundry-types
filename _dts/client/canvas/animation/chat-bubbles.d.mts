...
export default class ChatBubbles {
     ...
     */
    broadcast(token: TokenDocument, message: string, options?: ChatBubbleOptions): Promise<HTMLElement | null>;
    /**
     ...
     */
    say(token: Token, message: string, { cssClasses, requireVisible, pan }?: ChatBubbleOptions): Promise<HTMLElement | null>;
    /**
