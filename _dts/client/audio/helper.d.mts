...
export default class AudioHelper {
     ...
     */
    static AUDIO_CONTEXTS: ReadonlyArray<ContextName>;
    /**
     ...
     * @param {number} volume
     */
    static #onChangeMusicVolume(volume: number): void;
    /**
     * Handle changes to the global environment volume slider.
     * @param {number} volume
     */
    static #onChangeEnvironmentVolume(volume: number): void;
    /**
     * Handle changes to the global interface volume slider.
     * @param {number} volume
     */
    static #onChangeInterfaceVolume(volume: number): void;
    /**
     ...
     */
    static volumeToPercentage(volume: number, { label, decimalPlaces }?: {
     ...
     */
    static #createContext(volumeSetting: any): AudioContext;
    /**
     ...
     * @returns {Sound}
     */
    create({ src, context, singleton, preload, autoplay, autoplayOptions }: SoundCreationOptions): Sound;
    /**
     ...
     */
    play(src: string, { context, ...options }?: {
     ...
     */
    enableAnalyzer(contextName: ContextName, { keepAlive }?: {
     ...
     */
    getBandLevel(contextName: ContextName, bandName: BandName, { ignoreVolume }?: {
        ignoreVolume?: boolean | undefined;
    }): number;
    /**
     ...
     */
    getMaxBandLevel(band?: BandName, { ignoreVolume }?: {
        ignoreVolume?: boolean | undefined;
    }): number;
    /**
     ...
     * @ignore
     */
    getCache(src: any): AudioBuffer;
    /**
     * @deprecated since v12
     * @ignore
     */
    updateCache(src: any, playing?: boolean): void;
    /**
     * @deprecated since v12
     * @ignore
     */
    setCache(src: any, buffer: any): void;
    #private;
}
import type { AnalysisData } from "./_types.mjs";
import Sound from "./sound.mjs";
import AudioBufferCache from "./cache.mjs";
import type { SoundCreationOptions } from "./_types.mjs";
import type { ContextName } from "./_types.mjs";
import type { BandName } from "./_types.mjs";
