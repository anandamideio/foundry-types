 ...
 */
export function pauseGame(paused: boolean, options: {
 ...
 */
export function renderApplicationV2(application: ApplicationV2, element: HTMLElement, context: ApplicationRenderContext, options: ApplicationRenderOptions): void;
/**
 ...
 */
export function getHeaderControlsApplicationV2(application: ApplicationV2, controls: ApplicationHeaderControlsEntry[]): void;
/**
 ...
 */
export function pastePlaceableObject(objects: PlaceableObject[], data: object[], options: {
    cut: boolean;
}): void;
/**
 ...
 */
export function applyActiveEffect(actor: Actor, change: EffectChangeData, current: any, delta: any, changes: object): void;
/**
 ...
 */
export function updateCompendium(pack: CompendiumCollection<any>, documents: Document[], options: object, userId: string): void;
/**
 ...
 */
export function preCreateDocument(document: Document, data: object, options: Partial<DatabaseCreateOperation>, userId: string): boolean | void;
/**
 ...
 */
export function preUpdateDocument(document: Document, changed: object, options: Partial<DatabaseUpdateOperation>, userId: string): boolean | void;
/**
 ...
 */
export function preDeleteDocument(document: Document, options: Partial<DatabaseDeleteOperation>, userId: string): boolean | void;
/**
 ...
 */
export function updateDocument(document: Document, changed: object, options: Partial<DatabaseUpdateOperation>, userId: string): void;
/**
 ...
 */
export function preMoveToken(document: TokenDocument, movement: DeepReadonly<TokenMovementOperation>, operation: Partial<DatabaseUpdateOperation>): boolean | void;
/**
 ...
 */
export function moveToken(document: TokenDocument, movement: DeepReadonly<TokenMovementOperation>, operation: Partial<DatabaseUpdateOperation>, user: User): void;
/**
 ...
 */
export function chatBubbleHTML(token: Token, html: HTMLElement, message: string, options: ChatBubbleOptions): boolean | void;
/**
 ...
 */
export function modifyTokenAttribute({ attribute, value, isDelta, isBar }: {
    attribute: string;
    value: number;
    isDelta: boolean;
    isBar: boolean;
}, updates: objects, actor: Actor): void;
/**
 ...
 */
export function dealCards(origin: Cards, destinations: Cards[], { action, toCreate, fromUpdate, fromDelete }: {
    action: string;
    toCreate: object[];
    fromUpdate: object[];
    fromDelete: object[];
 ...
 * @param {object[]} context.fromDelete   Card deletion operations to be performed in the origin Cards document
 */
export function passCards(origin: Cards, destination: Cards, { action, toCreate, toUpdate, fromUpdate, fromDelete }: {
    action: string;
    toCreate: object[];
    toUpdate: object[];
    fromUpdate: object[];
 ...
 *                                                     document.
 */
export function returnCards(origin: Cards, returned: Card[], { toUpdate, fromDelete }: {
 ...
 */
export function applyCompendiumArt(documentClass: typeof Document, source: object, pack: CompendiumCollection<any>, art: CompendiumArtInfo): void;
/**
 ...
 */
export function preImportAdventure(adventure: Adventure, formData: object, toCreate: Record<string, object[]>, toUpdate: Record<string, object[]>): boolean | void;
/**
 ...
 */
export function importAdventure(adventure: Adventure, formData: object, created: Record<string, Document[]>, updated: Record<string, Document[]>): void;
/**
 ...
 */
export function combatStart(combat: Combat, updateData: {
    round: number;
    turn: number;
}): void;
/**
 ...
 */
export function combatTurn(combat: Combat, updateData: {
    round: number;
    turn: number;
}, updateOptions: {
    advanceTime: number;
 ...
 * @param {number} updateOptions.direction      A signed integer for whether the turn order is advancing or rewinding
 */
export function combatRound(combat: Combat, updateData: {
    round: number;
    turn: number;
}, updateOptions: {
    advanceTime: number;
 ...
 */
export function getProseMirrorMenuDropDowns(menu: ProseMirrorMenu, config: {
 ...
 */
export function createProseMirrorEditor(uuid: string, plugins: Record<string, Plugin>, options: {
    state: EditorState;
}): void;
/**
 ...
 */
export function chatInput(event: KeyboardEvent, options: {
 ...
 */
export function renderChatInput(app: ChatLog, elements: Record<string, HTMLElement>, context: RenderChatInputContext): void;
/**
 ...
 */
export function chatMessage(chatLog: ChatLog, message: string, { user, speaker }: {
    user: string;
...
import type { ApplicationRenderContext } from "./applications/_types.mjs";
...
import type { ApplicationHeaderControlsEntry } from "./applications/_types.mjs";
...
import type { CanvasLayer } from "./canvas/layers/_module.mjs";
...
import type { TokenMovementOperation } from "./documents/_types.mjs";
import type { User } from "./documents/_module.mjs";
import type { Token } from "./canvas/placeables/_module.mjs";
import type { ChatBubbleOptions } from "./canvas/animation/chat-bubbles.mjs";
import type { Note } from "./canvas/placeables/_module.mjs";
import type RenderedEffectSource from "./canvas/sources/rendered-effect-source.mjs";
import type { Cards } from "./documents/_module.mjs";
import type { Card } from "./documents/_module.mjs";
import type { CompendiumArtInfo } from "./helpers/_types.mjs";
import type ActorSheet from "./applications/sheets/actor-sheet.mjs";
import type { InteractionLayer } from "./canvas/layers/_module.mjs";
...
import type { WeatherEffects } from "./canvas/layers/_module.mjs";
import type { Adventure } from "./documents/_module.mjs";
import type { Combat } from "./documents/_module.mjs";
import type { CombatHistoryData } from "./documents/_types.mjs";
import type CombatConfiguration from "./data/combat-config.mjs";
import type ProseMirrorMenu from "@common/prosemirror/menu.mjs";
import type { ProseMirrorDropDownConfig } from "@common/prosemirror/_types.mjs";
import type { ProseMirrorMenuItem } from "@common/prosemirror/_types.mjs";
import type { HotReloadData } from "./_types.mjs";
import type ChatLog from "./applications/sidebar/tabs/chat.mjs";
import type { ChatMessage } from "./documents/_module.mjs";
import type AVSettings from "./av/settings.mjs";
import type { RollTable } from "./documents/_module.mjs";
